...
\fixme{рассматривая параматры скоуп и длина может возникнуть 4 варианта но по сути 3.}
...
\fixme{Proof that they have the same computational power - идите читайте Ахо на этот смысл}
