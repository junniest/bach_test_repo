...
def test_case_2 ():
    ...
    list_2 =   [t_id('f'), t_lbrace(), t_int(6), t_rbrace()]
    # f(6) - Should match #1
...
def test_case_3 ():
    ...
    list_2 = [t_id('g'), t_lbrace(), t_real(), t_delim_com(), t_int(),
              t_rbrace()]
    # g(real, int) - Should match #0
    
    list_3 = [t_id('e'), t_lbrace(), t_real(), t_rbrace()]
    # e(real) - Should match #0

    execute(regexp_1 + regexp_2 + list_1 + list_2 + list_3)

def test_case_4 ():
    """ A test for token type inheritance. """
    ...
    list_2 = [t_bool(True), t_delim_com()]
    # True, - Should match #1
